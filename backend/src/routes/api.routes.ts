...
import { getParkingSlots, createComplaint, getComplaints, createMaintenanceRequest, getMaintenanceRequests, getEvents, registerForEvent, getFacilities, bookFacility, getVisitors, approveVisitor, getAnnouncements, createAnnouncement, editAnnouncement, deleteAnnouncement, updateComplaintStatus, updateMaintenanceRequestStatus, cancelEventRegistration, cancelFacilityBooking, updateFacilityBookingStatus, markExitTime, assignParkingSlot, unassignParkingSlot, getAllApartments, addNewApartment, updateApartment, deleteApartment, registerVisitor } from '../controllers/apiController';
...
router.post('/events/:id',cancelEventRegistration);
